...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDispositivo).HasName("PK__Disposit__B1EDB8E4E1DC5661");
        ...
        {
            entity.HasKey(e => e.IdLocal).HasName("PK__LocalDis__C287B9BB029F9962");
        ...
        {
            entity.HasKey(e => e.IdManutencao).HasName("PK__Manutenc__CD0C6B2AF156CE88");
        ...
        {
            entity.HasKey(e => e.IdRegra).HasName("PK__RegraPer__E4F2CC248C5267CA");

            entity.ToTable("RegraPerfil");

            entity.HasIndex(e => e.Nome, "UQ__RegraPer__7D8FE3B2D247B421").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdTipoDispositivo).HasName("PK__TipoDisp__A9EEE64845621080");
        ...
        {
            entity.HasKey(e => e.IdTipoManutencao).HasName("PK__TipoManu__BE62BE4E72CFD1F1");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF9704B5C2C2");

            entity.ToTable("Usuario");

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534A78D76E7").IsUnique();
